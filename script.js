...
//  EMAILJS CONFIG
// Replace these three values with your own from the EmailJS dashboard:
// https://dashboard.emailjs.com/admin/account  (Public Key)
...
if (EMAILJS_PUBLIC_KEY.startsWith('YOUR_')) {
    console.warn(
        'EmailJS is not configured yet — replace EMAILJS_PUBLIC_KEY, ' +
  'EMAILJS_SERVICE_ID and EMAILJS_TEMPLATE_ID at the top of script.js ' +
        'with your real values, or the booking form will fail to send.'
    );
}
...
document.getElementById('booking-form').addEventListener('submit', function (e) {
    ...
    // Send via EmailJS — sendForm reads each input's "name" attribute,
